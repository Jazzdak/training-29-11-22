 ...
 */
final class Version20221201151044 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__movie AS SELECT id, title, poster, country, released_at, price, age FROM movie');
        ...
        , price INTEGER DEFAULT NULL, age VARCHAR(255) NOT NULL, CONSTRAINT FK_1D5EF26FB03A8386 FOREIGN KEY (created_by_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO movie (id, title, poster, country, released_at, price, age) SELECT id, title, poster, country, released_at, price, age FROM __temp__movie');
